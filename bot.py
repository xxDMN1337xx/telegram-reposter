...
async def check_with_gpt(text: str, client) -> str:
    ...
    prompt = (
        ...
        "- AI-инструменты, ИИ-инструменты, ИИ-сервисы, ИИ-редакторы или генераторы видео и изображений, Другие ИИ, нейросети, ChatGPT, MidJourney, Sora и другие генераторы и сервисы — даже если пост содержит только обзор, новость или инструкцию по использованию, даже без кейса\n"
